...
namespace BackgroundReader
{
    ...
    public class KeyboardListener : IDisposable
    {
        ...
        public KeyboardListener()
        {
            ...
            // Declare the events as nullable
            KeyDown = null!;
            KeyUp = null!;
        }
    ...
    public class RawKeyEventArgs(int VKCode, bool isSysKey) : EventArgs
    {
        /// <summary>
        /// VKCode of the key.
        /// </summary>
        public int VKCode = VKCode;

        /// <summary>
        /// WPF Key of the key.
        /// </summary>
        public Key Key = System.Windows.Input.KeyInterop.KeyFromVirtualKey(VKCode);

        /// <summary>
        /// Is the hitted key system key.
        /// </summary>
        public bool IsSysKey = isSysKey;
    }
